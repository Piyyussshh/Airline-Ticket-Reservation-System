...
public class AirlineTicketReservationSystem {
	public static void main(String[] args) {
		...
		try (Scanner sc = new Scanner(System.in)) {
			...
			System.out.println("Book your advance tickets between 30-03-2023 to " + pdate + " now.\n");
				...
				switch (ch) {
					case 1:
						...
						if (depr >= 0 && depr < 4 && arvl >= 0 && arvl < 4 && depr != arvl) {
							System.out.print("Enter date of travel[DD-MM-YYYY] between " + pdate + " to 30-04-2023 : ");
							String date = sc.next();
							System.out.printf("\n-----------------Available Flights :------------------\n\n");
							for (int i = 0; i < 20; i++) {
